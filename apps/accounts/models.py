...
class MyProfile(models.Model):
    ...
    mugshot=StdImageField(u'一卡通',upload_to='onecard',blank=True,variations={'thumbnail': (100, 75)})
    ...
    one_card=StdImageField(u'一卡通',upload_to='onecard',blank=True,variations={'thumbnail': (100, 75)}) # creates a thumbnail resized to maximum size to fit a 100x75 area
